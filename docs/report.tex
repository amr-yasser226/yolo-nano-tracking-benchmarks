...
\begin{figure}[H]
    ...
    \caption{Mean FPS comparison between pure detection and tracking.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../results/plots/04_stage_breakdown.png}
...
\begin{figure}[H]
    ...
    \caption{Sample frames with tracking annotations from YOLOv10n, YOLOv11n, and YOLOv12n.}
\end{figure}
